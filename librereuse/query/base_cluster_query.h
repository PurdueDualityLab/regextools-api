...
namespace rereuse::query {
    ...
    public:
        ...
        virtual std::vector<db::RegexEntity> query(const std::shared_ptr<rereuse::db::Cluster> &cluster, std::chrono::microseconds *duration, double *average_match_vector_length) = 0;
    };
}
